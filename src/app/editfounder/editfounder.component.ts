...
@Component({
  selector: 'app-editfounder',
  templateUrl: './editfounder.component.html',
  styleUrls: ['./editfounder.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class EditfounderComponent implements OnInit {
  ...
  public userSettingsStartup: any = {
    showCurrentLocation: false,
    resOnSearchButtonClickOnly: false,
    inputPlaceholderText: 'Enter Location',
    recentStorageName: 'componentData3',
    inputString: this.userModel.founder_startup_details.address1,
    showSearchButton: false,
    showRecentSearch: false

  };

  constructor(private http: Http, public router: Router, private commonApiService: CommonapiService,
 ...
 selectedItems_canHelp = [];
  selectedItems_canHelp_fraud = [];
  selectedItems_needHelp_fraud = [];
  ...
  years = [
    this.current_date, this.current_date - 1, this.current_date - 2, this.current_date - 3, this.current_date - 4,
 ...
 years_new = [
  ...
  ngOnInit() {
    ...
    if (this.userModel.root_user.user_address != null && this.userModel.root_user.user_address) {
      this.address_founder = this.userModel.root_user.user_address;
      this.lat_founder = this.userModel.root_user.user_latitude;
      this.lng_founder = this.userModel.root_user.user_longitude;
    }
    // set username
    ...
    if (this.userModel.root_user.user_about != null && this.userModel.root_user.user_about) {
      this.bio = this.userModel.root_user.user_about;
    }
    ...
    if (this.userModel.root_user.twitter_link != null && this.userModel.root_user.twitter_link) {
      this.twitter = this.userModel.root_user.twitter_link;
    }
    // set linkedin link
    if (this.userModel.root_user.linkedin_link != null && this.userModel.root_user.linkedin_link) {
      this.linkedin = this.userModel.root_user.linkedin_link;
    }
    // set can help with
    if (this.userModel.founder_details.tags_canhelp != null && this.userModel.founder_details.tags_canhelp) {
      ...
      if (stringToSplit.indexOf(',') >= 0) {
        ...
        if (stringToSplit != null && stringToSplit.length > 0) {
          ...
          for (var oneDropdown in this.dropdownList_canHelp) {
            if (stringToSplit.trim().indexOf(this.dropdownList_canHelp[oneDropdown].itemName) > -1) {
              var selectedItemsModel = new selectedItems();
              selectedItemsModel.id = this.dropdownList_canHelp[oneDropdown].id;
              selectedItemsModel.itemName = this.dropdownList_canHelp[oneDropdown].itemName;
              this.selectedItems_canHelp.push(selectedItemsModel);
              this.selectedItems_canHelp_fraud.push(selectedItemsModel);
            }
          }
        }
      } else {
        for (var oneDropdown in this.dropdownList_canHelp) {
          if (stringToSplit.trim() == this.dropdownList_canHelp[oneDropdown].itemName) {
            var selectedItemsModel = new selectedItems();
            selectedItemsModel.id = this.dropdownList_canHelp[oneDropdown].id;
            selectedItemsModel.itemName = this.dropdownList_canHelp[oneDropdown].itemName;
            this.selectedItems_canHelp.push(selectedItemsModel);
    ...
    if (this.userModel.founder_details.tags_needhelp != null && this.userModel.founder_details.tags_needhelp) {
      ...
      if (stringToSplit.indexOf(',') >= 0) {
        var splittedString = stringToSplit.split(',');
        if (stringToSplit != null && stringToSplit.length > 0) {
          for (var oneDropdown in this.dropdownList_needHelp) {
            if (stringToSplit.trim().indexOf(this.dropdownList_needHelp[oneDropdown].itemName) > -1) {
              var selectedItemsModel = new selectedItems();
              selectedItemsModel.id = this.dropdownList_needHelp[oneDropdown].id;
              selectedItemsModel.itemName = this.dropdownList_needHelp[oneDropdown].itemName;
              this.selectedItems_needHelp.push(selectedItemsModel);
              this.selectedItems_needHelp_fraud.push(selectedItemsModel);
        ...
        for (var oneDropdown in this.dropdownList_needHelp) {
          if (stringToSplit.trim() == this.dropdownList_needHelp[oneDropdown].itemName) {
            var selectedItemsModel = new selectedItems();
            selectedItemsModel.id = this.dropdownList_needHelp[oneDropdown].id;
            selectedItemsModel.itemName = this.dropdownList_needHelp[oneDropdown].itemName;
            this.selectedItems_needHelp.push(selectedItemsModel);
    ...
    // set race ethnicity
    if (this.userModel.root_user.user_background != null && this.userModel.root_user.user_background) {
      this.ethnicity_item = this.userModel.root_user.user_background;
    }
    // set user identify
    if (this.userModel.root_user.gender != null && this.userModel.root_user.gender) {
      this.gender_item = this.userModel.root_user.gender;
    }
    // set lgbt item
    if (this.userModel.root_user.user_identify != null && this.userModel.root_user.user_identify) {
      this.LGBT_item = this.userModel.root_user.user_identify;
    }
    // set age
    if (this.userModel.root_user.user_dob != null && this.userModel.root_user.user_dob) {
      this.age_item = this.userModel.root_user.user_dob;
    }
    ...
    if (this.userModel.founder_startup_details.title != null && this.userModel.founder_startup_details.title) {
      this.startupname = this.userModel.founder_startup_details.title;
    }
    // set startup address
    if (this.userModel.founder_startup_details.address1 != null && this.userModel.founder_startup_details.address1) {
      this.address_startup = this.userModel.founder_startup_details.address1;
      this.lat_startup = this.userModel.founder_startup_details.latitude;
      this.lng_startup = this.userModel.founder_startup_details.longitude;
    }
    ...
    if (this.userModel.founder_startup_details.startup_falls_under != null && this.userModel.founder_startup_details.startup_falls_under) {
      this.sector_item = this.userModel.founder_startup_details.startup_falls_under;
    }
    // set team size
    if (this.userModel.founder_startup_details.team_size != null && this.userModel.founder_startup_details.team_size) {
      this.team_item = this.userModel.founder_startup_details.team_size;
      this.people = this.team_item;
    }
    // set stage are you in
    if (this.userModel.founder_startup_details.stage_are_you_in != null && this.userModel.founder_startup_details.stage_are_you_in) {
      this.stage_item = this.userModel.founder_startup_details.stage_are_you_in;
    }
    // set when company was founded
    if (this.userModel.founder_startup_details.startup_founded_in != null && this.userModel.founder_startup_details.startup_founded_in) {
       this.year_item = this.userModel.founder_startup_details.startup_founded_in;
   
    }
    // set how much you raised to date
    if (this.userModel.founder_startup_details.how_mush_you_raised != null && this.userModel.founder_startup_details.how_mush_you_raised) {
      this.are_raised_item = this.userModel.founder_startup_details.how_mush_you_raised;
    }
    // set how much you looking to raise
    if (this.userModel.founder_startup_details.how_mush_you_like_to_rais != null && this.userModel.founder_startup_details.how_mush_you_like_to_rais) {
      this.have_raised_item = this.userModel.founder_startup_details.how_mush_you_like_to_rais;
    }
    // set funding round
    if (this.userModel.founder_startup_details.select_funding_round != null && this.userModel.founder_startup_details.select_funding_round) {
      this.round_item1 = this.userModel.founder_startup_details.select_funding_round;
    }
    // set company type
    if (this.userModel.founder_startup_details.type != null && this.userModel.founder_startup_details.type) {
      this.comp_type_item = this.userModel.founder_startup_details.type;
    }
    // set monthly_revenue_range
    if (this.userModel.founder_startup_details.revenue_range != null && this.userModel.founder_startup_details.revenue_range) {
      this.revenue_range_item = this.userModel.founder_startup_details.revenue_range;
    }
    // set past investors
    if (this.userModel.founder_startup_details.past_investors != null && this.userModel.founder_startup_details.past_investors) {
      this.past = this.userModel.founder_startup_details.past_investors;
    }
    // set years of experience
    if (this.userModel.founder_startup_details.founders_exp != null && this.userModel.founder_startup_details.founders_exp) {
      this.experience_item = this.userModel.founder_startup_details.founders_exp;
    }
    // set company's patent
    if (this.userModel.founder_startup_details.patent != null && this.userModel.founder_startup_details.patent) {
      this.patent_item = this.userModel.founder_startup_details.patent;
    }
    // set defensibility
    if (this.userModel.founder_startup_details.Defensibility != null && this.userModel.founder_startup_details.Defensibility) {
      this.defense = this.userModel.founder_startup_details.Defensibility;
    }
  ...
  part1_next() {
    ...
    console.log("AnilClicked" + this.need + this.selectedItems_needHelp);
    ...
    if(this.selectedItems_canHelp != null && this.selectedItems_canHelp && this.selectedItems_canHelp.length>0){
     //do nthg
    }else{
       for(var x in this.selectedItems_canHelp_fraud){
        this.selectedItems_canHelp.push(this.selectedItems_canHelp_fraud[x]);
       }
    }

 if(this.selectedItems_needHelp != null && this.selectedItems_needHelp && this.selectedItems_needHelp.length>0){
     //do nthg
    }else{
       for(var x in this.selectedItems_needHelp_fraud){
        this.selectedItems_needHelp.push(this.selectedItems_needHelp_fraud[x]);
       }
    }
      ...
      this.commonApiService.update(jwtToken, fd).subscribe(
        response => {
          ...
          if (response.status == 200) {
            ...
            var founderName = this.res.founder_startup_details.founder_name;
 ...
 if (this.logo_hero) {
                ...
                this.logo_hero = this.heroImageUrl4;
            }

            if (this.logo) {
                // do nothing
            } else {
                this.logo = this.heroImageUrl3;
            }
